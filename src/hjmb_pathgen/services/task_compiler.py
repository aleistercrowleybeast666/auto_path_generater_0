...
from hjmb_pathgen.models.enums import PathSource, RouteFamily, StorageMode, UnloadMask, YawPolicy
from hjmb_pathgen.models.errors import CompileError
from hjmb_pathgen.models.project import ProjectV40
from hjmb_pathgen.models.route_case import CaseManifestV40, RouteCaseRowV40
from hjmb_pathgen.models.task_mapping import DropTarget, drop_targets_from_label_positions
from hjmb_pathgen.models.task_plan import CandidatePlan, TransitionRequirement, UnloadStep
from hjmb_pathgen.services.action_source_compiler import compile_source_actions
...
def _drop_pose(project: ProjectV40, anchor_site: str, unload_mask: UnloadMask, yaw_ddeg: int) -> dict[str, Any]:
    ...
    profile = _unload_profile(project, unload_mask)
    return {
        "x_mm": int(site.get("x_mm", 0)) + int(profile.get("dx_mm", 0)),
        "y_mm": int(site.get("y_mm", 0)) + int(profile.get("dy_mm", 0)),
