...
from hjmb_pathgen.models.task_plan import CandidatePlan
from hjmb_pathgen.services.case_draft_service import CaseDraftResult, generate_case_draft
from hjmb_pathgen.services.project_service import ProjectLayout
from hjmb_pathgen.services.task_compiler import compile_task_candidates
...
def unlock_candidate(layout: ProjectLayout, traj_id: int) -> CaseDraftResult:
    current_id = None
    case_path = layout.case_json_path(traj_id)
    if case_path.exists():
