...
from hjmb_pathgen.py_io.codecs.validators import validate_compiled_trajectory
...
from hjmb_pathgen.py_domain.errors import CompileError, MissingDependencyError, StaleDependencyError
...
def _make_header(case: CaseManifestV40, project: ProjectV40 | None, segments: tuple[SegmentV40, ...]) -> HeaderV40:
    route_family = _enum_int(RouteFamily, case.selected_plan.get("route_family", RouteFamily.MANUAL))
